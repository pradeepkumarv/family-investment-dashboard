...
export default async function handler(req, res) {
  ...
  try {
    // Defensive: Parse the JSON body properly
    let body = req.body;
    if (!body) {
      const buffers = [];
    ...
    // Forward the request to Zerodha's actual API
    ...
    // Defensive: handle Zerodha API errors
    ...
    // Send the Zerodha response status and body to frontend
